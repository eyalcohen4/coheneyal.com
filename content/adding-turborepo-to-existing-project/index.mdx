...
You can see the PR here. It's gigantic, and include 78 files changed. Thanks to the help of Steven I was able to get it out of the door.
...
Uner the hood, turborepo uses the [workspaces](https://turbo.build/repo/docs/handbook/workspaces) feature package managers like pnpm and yarn provide.
...
2. **Add react as peerDependency**
   We need React as a peerDependencies, because we want to avoid bundling it with our package, as it's already bundled with our apps.
...
To run typescript and tailwind, we need to define our build configs to bundle our package.
...
As everything is ready, we need to add an export file for the ui package.
...
_If you have any question, feel free to send it to me at eyal@coheneyal.com or on [twitter](https://twitter.com/cohen_eyal4)._
