...
The components are made to be accessible since the underline library is [radix-ui](https://www.radix-ui.com/), which is an _Unstyled, accessible component library for React._
